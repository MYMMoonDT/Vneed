...
<asp:Panel ID="MyVneedMyOrderListContainerPanel" runat="server" CssClass="myVneedMyOrderListContainer">
    <div class="myOrderItemContainer">
        ...
        <div class="myOrderItemDetailContainer">
                <div>订单号：<asp:Label runat="server" Text=""></asp:Label></div>
                <div>下单日期：<asp:Label ID="Label1" runat="server" Text=""></asp:Label></div>
                <div>付款方式：<asp:Label ID="Label2" runat="server" Text=""></asp:Label></div>
                <div>金额：<asp:Label ID="Label3" runat="server" Text=""></asp:Label></div>
        </div>
